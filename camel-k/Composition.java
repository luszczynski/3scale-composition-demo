    ...
    public void configure() throws Exception {
        ...
        from("direct:person").routeId("Person Route")
            //.circuitBreaker()
                ...
                .toD("http://pessoas-quarkus-demo:8080/pessoas/${headers.CamelHttpPath}?bridgeEndpoint=true")
            //.onFallback()
        ...
        from("direct:accounts").routeId("Accounts Route")
            .circuitBreaker()
                ...
                .toD("http://contas-corrente-quarkus-demo:8080/contas/${headers.CamelHttpPath}?bridgeEndpoint=true")
            .onFallback()
        ...
        from("direct:kafka-audit").routeId("Kafka Route")
            ...
            .to("kafka:auditoria?brokers=my-cluster-kafka-bootstrap.fuse.svc:9092")
        .end();
    }
